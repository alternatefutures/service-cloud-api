...
describe('RuntimeRouter', () => {
  ...
  describe('handleRequest', () => {
    ...
    it('should handle function with multiple routes', async () => {
      ...
      expect(vi.mocked(fetch).mock.calls[0][0]).toBe('https://auth.example.com/login');
      ...
      expect(vi.mocked(fetch).mock.calls[1][0]).toBe('https://users.example.com/123');
      ...
      expect(vi.mocked(fetch).mock.calls[2][0]).toBe('https://api.example.com/products');
      ...
      expect(vi.mocked(fetch).mock.calls[3][0]).toBe('https://default.example.com/homepage');
    });
