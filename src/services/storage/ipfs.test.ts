...
const { mockPinFileToIPFS, mockPinFromFS, mockTestAuthentication, MockPinataClient } = vi.hoisted(() => {
  ...
  return { mockPinFileToIPFS, mockPinFromFS, mockTestAuthentication, MockPinataClient };
});
...
describe('IPFSStorageService', () => {
  ...
  describe('Constructor', () => {
    ...
    it('should throw error when credentials are missing', () => {
      ...
      expect(() => new IPFSStorageService()).toThrow('Pinata API credentials not configured');
    });
