...
describe('SelfHostedIPFSStorageService', () => {
  ...
  describe('pin', () => {
    ...
    it('should handle pin errors', async () => {
      ...
      await expect(service.pin('QmTest123')).rejects.toThrow(
        'IPFS pin failed: Pin failed'
      )
    })
  ...
  describe('unpin', () => {
    ...
    it('should handle unpin errors', async () => {
      ...
      await expect(service.unpin('QmTest123')).rejects.toThrow(
        'IPFS unpin failed: Unpin failed'
      )
    })
    ...
    it('should handle unknown unpin errors', async () => {
      ...
      await expect(service.unpin('QmTest123')).rejects.toThrow(
        'IPFS unpin failed: Unknown error'
      )
    })
  })
  ...
  describe('get', () => {
    ...
    it('should handle get errors', async () => {
      ...
      await expect(service.get('QmTest123')).rejects.toThrow(
        'IPFS get failed: Get failed'
      )
    })
