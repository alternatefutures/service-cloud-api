...
describe('IPFSWithTracking', () => {
  ...
  beforeEach(() => {
    ...
    ipfsService = new IPFSWithTracking(
  ...
  describe('unpinWithTracking', () => {
    it('should track unpin event', async () => {
      const result = await ipfsService.unpinWithTracking(
        'QmTest123',
        'user-123'
      )
      ...
      expect(mockTracker.trackUnpinEvent).toHaveBeenCalledWith(
        'user-123',
        'QmTest123'
      )
    })
  ...
  describe('getActivePins', () => {
    it('should return active pins for user with default limit', async () => {
      ...
      expect(mockTracker.getActivePins).toHaveBeenCalledWith(
        'user-123',
        undefined
      )
    })
