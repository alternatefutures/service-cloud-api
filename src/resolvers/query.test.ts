...
describe('Query Resolvers', () => {
  ...
  describe('project', () => {
    it('should return project by id', async () => {
      ...
      const result = await resolvers.Query.project({}, { id: 'project-123' }, mockContext);
  ...
  describe('projects', () => {
    ...
    it('should throw error if not authenticated', async () => {
      ...
      await expect(resolvers.Query.projects({}, {}, mockContext)).rejects.toThrow(
        'Not authenticated'
      );
    });
  });
  ...
  describe('site', () => {
    it('should return site by id', async () => {
      ...
      const result = await resolvers.Query.site({}, { id: 'site-123' }, mockContext);
  ...
  describe('siteBySlug', () => {
    it('should return site by slug', async () => {
      ...
      const result = await resolvers.Query.siteBySlug({}, { slug: 'test-site' }, mockContext);
  ...
  describe('afFunctionByName', () => {
    it('should return function by name', async () => {
      ...
      vi.mocked(mockContext.prisma.aFFunction.findFirst).mockResolvedValue(mockFunction);
    ...
    it('should throw error if project ID is missing', async () => {
      ...
      await expect(
        resolvers.Query.afFunctionByName({}, { name: 'test-function' }, mockContext)
  ...
  describe('afFunctions', () => {
    ...
    it('should throw error if project ID is missing', async () => {
      ...
      await expect(resolvers.Query.afFunctions({}, {}, mockContext)).rejects.toThrow(
        'Project ID required'
      );
    });
  });
